...
2. Copy the ssh URL from the blue Gitlab "Clone" button on the
   ...
   .. code-block:: bash
      ...
      ssh://git@re-git.lanl.gov:10022/aea/stub-repositories/micromorphic_tools.git
...
4. Clone the stub repository using the URL copied in step 2.
   ...
   .. code-block:: bash
      ...
      $ git clone ssh://git@re-git.lanl.gov:10022/aea/stub-repositories/micromorphic_tools.git
...
https://aea.re-pages.lanl.gov/stub-repositories/micromorphic_tools. This job should be
...
3. Search and replace from command line
   ...
   .. code-block:: bash
      ...
      $ sed -i 's/CPP_STUB/MY_PROJECT/g' $(grep -ri micromorphic_tools . --exclude-dir={build,.git} -l)
...
7. Rename files after current project
   ...
   .. code-block:: bash
      ...
      $ rename micromorphic_tools myproject $(find . -type d \( -name .git -o -name build \) -prune -false -o -name "*micromorphic_tools*")
